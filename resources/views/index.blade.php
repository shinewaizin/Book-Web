@extends('master')
@section('title') Books Lists @endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card mt-5 cardBgColor border-0">
                        <div class="card-header bgmColor twoColor d-flex justify-content-between align-items-center ">
                            <h3 class="m-0">Book Categories</h3>
                            <div>
                                <a href="{{route('home')}}" class="btn btn bubg tn-lg m-0 mainColor">To Home</a>
                                <a href="{{route('create')}}" class="btn btn bubg tn-lg m-0 mainColor">To Upload</a>
                            </div>
                        </div>
                        <div class="card-body bgmColor">
                            <div class="searchBar">
                                <form action="">
                            ...
                            <div class="cardContainer p-3 mt-5">
                                <div class="row">
                                    @foreach($books as $book)
                                    <div class="col-3">

                                        <div class="card border-0  ">
                                            <div class="card-body bgmColor cardBgColor bookCardContainer">

                                        {{--Card Title And Cover --}}
                                                <a href="{{route('show',$book->id)}}">
                                                    <div class="titleCover text-white Kfont">
                                                        <div class="row">
                                                            <div class="col-6 d-flex align-items-center">
                                                                <h5 class="text-center">{{$book->name}}</h5>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="cardBgMainColor">
                                                ...
                                                <div class="d-flex align-items-center my-2">
                                                    <a href="{{route('edit',$book->id)}}" class="btn btn-info btn-sm mx-2">Edit</a>
                                                ...
                                                {{--Card Title And Cover --}}
                                                <div class="summarize text-white">
                                                    <h6 class="Mfont ">Summarize.....</h6>
                                                    <p>
                                                        {{Str::words($book->summary,15,'> > >')}}
                                                    </p>
                                                </div>

                                                <small class="twoColor outlineText">✡ biography of benjamin franklin </small>
                                           </div>
