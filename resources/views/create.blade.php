                        ...
                        <div class="card-body border-0 bgmColor">\
                            <form action="{{route('store')}}" method="post">
                                ...
                                <div class="row">
                                        <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{old('name')}}" name="name">
                                                    @error('name')
                                                ...
                                                <div class="form-group my-5">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg @error('type') is-invalid @enderror" value="{{old('type')}}" name="type">
                                                    @error('type')
                                                    <small class="text-danger">{{$message}}</small>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" name="photo" class="form-control form-control-lg file twoColor @error('photo') is-invalid @enderror" value="{{old('photo')}}">
                                                            @error('photo')
                                                            <small class="text-danger">{{$message}}</small>
                                                            @enderror
                                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="summary" id="" cols="30" rows="10" class="form-control form-control-lg @error('summary') is-invalid @enderror ">{{old('summary')}}</textarea>
                                                @error('summary')
                                                <small class="text-danger">{{$message}}</small>
                                                @enderror
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="about" id="" cols="30" rows="10" class="form-control form-control-lg @error('about') is-invalid @enderror ">{{old('about')}}</textarea>
                                    @error('about')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
